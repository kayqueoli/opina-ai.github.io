    ...
    ThankyouPage.prototype.resolvePerson = function () {
        ...
        this.personQuote =
            'Por favor, nos ajude a avaliar a <strong>gamificação do aplicativo</strong> respondendo o '
                ...
                + '<a *ngIf="useGame" href="' + this.form_url + '" target="_blank">Avaliação da Gamificação</a>';
    };
    ...
    ThankyouPage.prototype.help = function () {
        ...
        var alert = this.alertCtrl.create({
            ...
            '<div class="alert-align-center">'
                ...
                + '<div text-center>Por favor, nos ajude a avaliar a <strong>gamificação do aplicativo</strong> respondendo o <strong>formulário: <a style="font-size:1.5rem" href="' + this.form_url + '" target="_blank"><strong>Avaliação da gamificação</strong></a></div>'
                + '</div></div>',
            //----------------------MENSAGEM------------------
            buttons: [{
                    text: "sair",
    ...
    ThankyouPage.prototype.showFormNotGame = function () {
        ...
        var alert = this.alertCtrl.create({
            ...
            '<div class="tdialogue-box-text">'
                + '<div text-center>Por favor, nos ajude a avaliar o <strong>aplicativo</strong> respondendo o <strong>formulário: <a style="font-size:1.5rem" href="' + this.form_url + '" target="_blank"><strong>Avaliação do Aplicativo</strong></a></div>'
                + '<div text-center></div>'
                + '</div>',
            //----------------------MENSAGEM------------------
            buttons: [{
