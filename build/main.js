...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_question_question__ = __webpack_require__(213);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__providers_question_question__["a" /* QuestionProvider */],
...
var QuestionaryProvider = /** @class */ (function () {
    ...
    QuestionaryProvider.prototype.getAllResultsByQuestionaryCourse = function (questionary, respondent) {
        var _this = this;
        var respondentJson = {
            courseEntry: (respondent.courseEntry == 'Todos') ? null : respondent.courseEntry,
            courseName: (respondent.courseName == 'Todos') ? null : respondent.courseName,
            type: (respondent.type == 'Todos') ? null : respondent.type,
        };
        var json = {
            "id": questionary.id,
            "course_entry": respondentJson.courseEntry ? respondentJson.courseEntry : null,
            "course_name": respondentJson.courseName ? respondentJson.courseName : null,
            "type": respondentJson.type ? respondentJson.type : null
        };
        var data = JSON.stringify(json);
        return new Promise(function (resolve) {
            _this.http.post(_this.restProvider.API_URL + "get-results-by-questionary-course.php", data, { headers: _this.restProvider.headers })
                .subscribe(function (data) {
                resolve(data);
            }, function (error) {
                console.error(error);
                _this.restProvider.sendGoogleAnalyticsErrorData('QuestionaryProvider', 'getAllResultsByQuestionaryCourse', error);
                resolve(error);
            });
        });
    };
                            ...
                            if (plans != null) {
                                _this.storage.set('city', _this.city).then(function () {
                                    ...
                                    _this.plans.forEach(function (p) {
                                        ...
                                        if (p.name == "Levantamento sobre a Saúde Mental - UNIFEI") {
                                            _this.plan = p;
    ...
    IntroPage.prototype.existsAppCityPlan = function () {
        ...
        this.databaseProvider.verifyEntities(entities)
            ...
            if (data.length > 0 && data.filter(function (data) { return data == false; }).length == 0) {
                _this.storage.get('respondent')
                    .then(function (respondent) {
                    if (respondent != null && respondent.caseTest == "Levantamento sobre a Saúde Mental - UNIFEI") {
