...
var QuestionaryPage = /** @class */ (function () {
    ...
    QuestionaryPage.prototype.resolveQuestion = function () {
        this.progress = ((this.currentQuestionIndex + 1) / this.questions.length) * 100;
        this.totalQuestions = this.questions.length;
        if (this.currentQuestion.showDontNow == "0") {
        ...
        if (this.currentQuestion.useAnswerText == "0") {
            this.showAnswerText = false;
            this.showYesNo = true;
        }
        else {
    ...
    //Carrega as métricas e vai para a página de priorização
    QuestionaryPage.prototype.loadMetricsFromList = function (metricId) {
        var _this = this;
        //------------------------CARREGA OS ITENS DE MÉTRICAS-----------------------------
        //1 - GUT, 2 - ESCALA QUALITATIVA, (3-17) - Métricas do questionário de teste
