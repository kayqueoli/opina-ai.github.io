...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__questionary__ = __webpack_require__(440);
...
var QuestionaryPageModule = /** @class */ (function () {
    ...
    QuestionaryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__questionary__["a" /* QuestionaryPage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_question_question__ = __webpack_require__(213);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_prioritization_prioritization__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_answer_answer__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__home_home__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_rest_rest__ = __webpack_require__(12);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuestionaryPage = /** @class */ (function () {
    function QuestionaryPage(toastCtrl, menuCtrl, navCtrl, navParams, questionProvider, storage, databaseProvider, loadingCtrl, alertCtrl, priorizationProvider, answerProvider, keyboard, platform, restProvider) {
        var _this = this;
        ...
        this.isRuralZone();
        var entities = ['metricItems', 'respondent'];
    ...
    QuestionaryPage.prototype.setEntities = function () {
        var _this = this;
        this.storage.get('metricItems').then(function (data) { return _this.metricItems = data; });
        this.storage.get('respondent').then(function (data) { return _this.respondent = data; });
        this.storage.get('plan').then(function (data) { return _this.plan = data; });
    };
    QuestionaryPage.prototype.getAllQuestionsByQuestionary = function (questionary, currentIndex, isRuralZone) {
        ...
        this.questionProvider.getAllQuestionsByQuestionary(questionary, isRuralZone)
            ...
            if (result != null) {
                ...
                _this.showAlertGetAllQuestionsByQuestionary(questionary, currentIndex, isRuralZone);
            }
        })
            .catch(function (error) {
            console.error(error);
            _this.restProvider.sendGoogleAnalyticsErrorData('QuestionaryPage', 'getAllQuestionsByQuestionary', error);
            _this.showAlertGetAllQuestionsByQuestionary(questionary, currentIndex, isRuralZone);
        });
    };
    QuestionaryPage.prototype.isRuralZone = function () {
        ...
        this.storage.get('isRuralZone')
            ...
            console.error(error);
            _this.restProvider.sendGoogleAnalyticsErrorData('QuestionaryPage', 'isRuralZone', error);
    ...
    QuestionaryPage.prototype.finishQuestionary = function () {
        ...
        this.answerProvider.insertAnswersData(this.answers, this.answersNeighborhoods, this.prioritizations, this.userType, this.useGame, this.points)
            ...
            if (data != null) {
                ...
                _this.showAlertFinishQuestionary();
                _this.loader.dismiss();
            }
        }).catch(function (error) {
            console.error(error);
            _this.restProvider.sendGoogleAnalyticsErrorData('QuestionaryPage', 'finishQuestionary', error);
            _this.showAlertFinishQuestionary();
            _this.loader.dismiss();
        });
    };
    ...
    QuestionaryPage.prototype.showAlertGetAllQuestionsByQuestionary = function (questionary, currentIndex, isRuralZone) {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Oops!',
            message: 'Não foi possível acessar os dados das questões do questionário. Por favor, tente novamente.',
            buttons: [{
                    text: "Tentar novamente",
                    handler: function () {
    ...
    QuestionaryPage.prototype.showAlertFinishQuestionary = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Oops!',
